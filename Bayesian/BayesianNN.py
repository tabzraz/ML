...
class BayesianFC:
    ...
    def calculate_loss(self, data, N):
        ...
        return loss, weight_variables, variational_mean_variables, variational_std_variables

    def update(self, data, N, sess, optimiser):
        loss, w_vars, v_m_vars, v_std_vars = self.calculate_loss(data, N)
        ...
        new_variational_mean_grads_and_vars = [(gv+gw,v) for (gw,_),(gv,v) in zip(weight_grads_and_vars, variational_mean_variables)]
